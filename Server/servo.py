...
from Server.myparameter import ParameterManager
...
class Servo:
    def __init__(self):
        ...
        #self.pwm.setServoPwm("0", 150)  # Set initial angle for servo 0
        #self.pwm.setServoPwm("1", 90)  # Set initial angle for servo 1
